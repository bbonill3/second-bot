...
def bot(user_location):
    ...
    list_of_hoods = data['neighborhood']
    if user_location in list_of_hoods:
        make_story(user_location, items)
    else:
        print("That's not a neighborhood in Seattle! Here is a list of Seattle neighborhoods:" list_of_hoods)

"""
    ['Admiral', 'Alki', 'Arbor Heights', 'Ballard', 'Beacon Hill', Belltown, "Blue Ridge", Brighton,
    Broadview, "Capitol Hill", "Central District", Chinatown International District, Colman, Columbia City, Crown Hill,
    Delridge, Downtown, Duwamish, Eastlake, Fauntleroy, First Hill, Fremont, Fremont, Genesee-Schmitz, Georgetown,
    Green Lake, Greenwood, Haller Lake, Hawthorne Hills, Highland Park, Hillman City, Industrial District, Junction, Lake City,
    Lake Union, Lakewood/Seward Park, Laurelhurst, Leschi, Lewis Park, Licton Springs, Lockmore, Madison Park, Madrona,
